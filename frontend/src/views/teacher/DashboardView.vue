...
<template>
  <AppLayout>
    <div class="dash">
      ...
      <!-- ── Stats ──────────────────────────────────────────────────── -->
      <section class="stats">
        <div v-for="s in stats" :key="s.key" class="stat-card" :class="'stat-' + s.color">
          <div class="stat-icon">{{ s.icon }}</div>
          <div class="stat-body">
            <div class="stat-value">
              <span class="stat-num">{{ s.value !== null ? s.value : '—' }}</span>
...
/* ═══════════════════════════════════════════════════════════════════════
   ...
   Hero + KPI stats + pending timeline + section directory.
   ═══════════════════════════════════════════════════════════════════════ */
