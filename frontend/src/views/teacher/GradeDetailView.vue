...
.content-grid{display:grid;grid-template-columns:1.12fr .88fr;gap:15px}.question-panel,.analysis-card,.teacher-card,.ability-card{border:1px solid var(--border);border-radius: var(--radius-lg);background:var(--surface);box-shadow:none}.question-panel{overflow:hidden}.question-panel>h2,.analysis-card>h2,.teacher-card h2,.ability-card h2{margin:0;color:var(--fg);font-size:15px}.question-panel>h2{padding:16px 18px}.question-group{margin:0 14px 12px;border:1px solid var(--border);border-radius: var(--radius-md);overflow:hidden}.question-group>header{display:flex;justify-content:space-between;padding:10px 12px;background:var(--surface-subtle);color:var(--fg);font-size:13px}.question-group>header span{font-weight:600}.question-row{border-top:1px solid var(--border)}.question-row:first-of-type{border-top:0}.question-row>button{display:grid;grid-template-columns:25px 1fr 65px 78px 18px;align-items:center;gap:8px;width:100%;padding:9px 10px;border:0;border-radius:0;background:var(--surface);text-align:left}.question-row>button:hover{background:var(--surface-subtle)}.question-number{display:grid;place-items:center;width:22px;height:22px;border-radius: var(--radius-md);color:var(--accent);background:var(--accent-soft);font-size:11px}.question-prompt{overflow:hidden;color:var(--muted);font-size:12px;text-overflow:ellipsis;white-space:nowrap}.question-row>button strong{color:var(--fg);font-size:12px;text-align:right}.answer-state{font-size:11px;text-align:center}.answer-state.correct{color:var(--success)}.answer-state.partial{color:var(--warning)}.answer-state.wrong{color:var(--danger)}.answer-state.pending{color:var(--muted)}.answer-detail{padding:12px 16px;border-top:1px dashed var(--border);background:var(--surface-subtle)}.answer-detail small{display:block;margin-bottom:5px;color:var(--muted)}.answer-detail p{margin:0;color:var(--fg);font-size:13px}.answer-detail pre{max-height:230px;margin:0;overflow:auto;padding:12px;border-radius: var(--radius-md);color:var(--info-bg);background:var(--fg);font-family:var(--font-mono);font-size:12px;white-space:pre-wrap}.error-note{margin-top:8px!important;color:var(--danger)!important}
