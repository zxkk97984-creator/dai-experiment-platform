...
.workspace{display:grid;grid-template-columns:220px minmax(0,780px);gap:22px;align-items:start}.exam-sidebar{position:sticky;top:24px;min-width:0;padding:20px;border:1px solid var(--border);border-radius:15px;background:var(--surface)}.save-row{display:flex;align-items:center;gap:8px;color:var(--fg);font-size:12px}.save-dot{width:7px;height:7px;border-radius:50%;background:var(--success)}.save-dot.saving,.save-dot.pending{background:var(--warning)}.save-dot.danger{background:var(--danger)}.progress-line{height:6px;margin:16px 0 8px;border-radius: var(--radius-full);background:var(--border);overflow:hidden}.progress-line span{display:block;height:100%;border-radius:inherit;background:var(--accent);transition:width .25s}.exam-sidebar>p,.exam-sidebar>small{color:var(--muted);font-size:11px}.exam-sidebar nav{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:7px;margin:20px 0}.exam-sidebar nav button{box-sizing:border-box;width:100%;min-width:0;min-height:0;aspect-ratio:1;border:1px solid var(--border);border-radius: var(--radius-md);background:white;color:var(--muted);cursor:pointer}.exam-sidebar nav button.answered{border-color:var(--success-bg);background:var(--success-bg);color:var(--success)}.exam-sidebar nav button.current{outline:2px solid var(--info-bg)}.submit-button{width:100%;padding:10px;border:0;border-radius: var(--radius-md);background:var(--fg);color:white;font-weight:650;cursor:pointer}.submit-button:disabled{opacity:.5}.exam-sidebar>small{display:block;margin-top:9px;text-align:center;line-height:1.5}
