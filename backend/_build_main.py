"""Build main.py with all handlers"""
code = r'''from fastapi import FastAPI, HTTPException, Request
...
def create_app(settings: Settings | None = None) -> FastAPI:
    ...
    async def validation_exception_handler(_: Request, exc: RequestValidationError):
        return JSONResponse(
            status_code=422,
            content={"detail": {"code": "VALIDATION_ERROR", "message": "请求参数校验失败", "fields": {"errors": exc.errors()}}},
        )
...
'''
import pathlib
pathlib.Path('backend/app/main.py').write_text(code, encoding='utf-8')
print('main.py built')
